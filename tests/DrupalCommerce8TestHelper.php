...
class DrupalCommerce8TestHelper {
	...
	/**
	 * DrupalCommerce8TestHelper constructor.
	 *
	 * @param \DrupalCommerce8\DrupalCommerce8FullTest $drupalcommerce8_test
	 */
	public function __construct( $drupalcommerce8_test ) {
		$this->main_test    = $drupalcommerce8_test;
		$this->wd           = $drupalcommerce8_test->wd;
	 ...
	 * @param bool $is_admin
	 *
	 * @return DrupalCommerce8TestHelper
